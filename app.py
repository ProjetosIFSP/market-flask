...
def novo_cliente():
    ...
    return render_template('form_cliente.html', estados=estados, titulo='Novo cliente', action=url_for('novo_cliente'))

@app.route('/clientes/edit/<int:idcliente>', methods=['GET', 'POST'])
def edit_cliente(idcliente):
    ...
    estados = ["AC", "AL", "AP", "AM", "BA", "CE", "DF", "ES", "GO", "MA", "MT", "MS", "MG", "PA", "PB", "PR", "PE", "PI", "RJ", "RN", "RS", "RO", "RR", "SC", "SP", "SE", "TO"]
    return render_template('form_cliente.html', titulo='Alterando cliente', action=url_for('edit_cliente', idcliente=idcliente), cliente=cliente, estados=estados)

@app.route('/clientes/delete/<int:idcliente>', methods=['POST'])
...
@app.route('/clientes/delete-multiple', methods=['POST'])
